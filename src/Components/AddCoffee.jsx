...
const AddCoffee = () => {
    return (
        <div className='w-8/12 mx-auto'>
            ...
            <div className='bg-[#F4F3F0] px-25 py-10 rounded-2xl'>
                <div className='max-w-3xl mx-auto'>
                    <h3 className='text-xl font-bold py-3 text-center'>Add New Coffee</h3>
                ...
                <form className='my-10'>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'> 
                        ...
                        <fieldset className="fieldset bg-base-200 border-base-300 rounded-box  border p-4">
                            ...
                            <input type="text" className="input w-full" placeholder="Enter coffee price" />
                        </fieldset>
                        <fieldset className="fieldset bg-base-200 border-base-300 rounded-box  border p-4">

                            <label className="label">Details</label>
                            <input type="url" className="input w-full" placeholder="Enter coffee details" />
                        </fieldset>
